...
<footer style="color: {themes[theme]['text']}; background-color: {themes[theme]['pale']};">
	<div class="col-wide" data-analytics="footer">
		<a href="#">
			...
			<img
				class="logo-img"
				src="./img/enaira-logo.png"
				alt="E-naira Statistics" />
			{:else}
			<img
				class="logo-img"
				src="./img/enaira-logo.png"
		...
		<ul>
			<li><a href="#" class="link" style="color: {themes[theme]['text']}">Contact us</a></li>
			<li><a href="#" class="link" style="color: {themes[theme]['text']}">Cookies and privacy</a></li>
		</ul>
		<hr style="border-top-color: {themes[theme]['muted']}" />
		<div class="license">
			<!--<svg class="ogl-img" viewBox="0 0 59 24" xmlns="http://www.w3.org/2000/svg">
				<title>CBN Licence</title>
			...
			<a
				...
				target="_blank"
				rel="noopener"
				style="color: {themes[theme]['text']}">CBN Licence</a>, 
